...
describe('Scope', function () {
  ...
  describe('digest', function () {
    ...
    it('allows destroying a $watch during the digest cycle', function () {
      scope.aValue = 'abc';
    ...
    it('allows a $watch to destroy another watcher during $digest', function () {
      scope.aValue = 'abc';
      scope.counter = 0;
  ...
  describe('$watchGroup', function () {
    ...
    it('only calls the listener once per digest', function () {
      var counter = 0;
  ...
  describe('inheritance', function () {
    ...
    it('can manipulate a parents scope property', function () {
      var parent = new Scope();
      var child = parent.$new();
      parent.aValue = [1, 2, 3];
